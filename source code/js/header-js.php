...
if(isset($_SESSION['login_company_name']))
{
echo 'session_login_company_name = \'' . $_SESSION['login_company_name'] . '\';';
}
...
if(isset($_SESSION['logged_in']))
{
	...
	if(isset($_SESSION['just_registered'])){
	 echo 'session_just_registered = 1;';}
	 else{
	  echo 'session_just_registered = 0;';}
	  
	  if(isset($_SESSION['just_signed_up'])){
	 echo 'session_just_signed_up = 1;';}
	 else{
	  echo 'session_just_signed_up = 0;';}
